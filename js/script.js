...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const branchData = {
    ...
    'Хамовники': { phone: '+74951234569', masters: [['Егор Смирнов', 'Ведущий барбер · 8 лет опыта', 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?auto=format&fit=crop&w=900&q=85'], ['Никита Морозов', 'Барбер-стилист · 5 лет опыта', 'https://images.unsplash.com/photo-1501196354995-cbb51c65aaea?auto=format&fit=crop&w=900&q=85'], ['Анна Соколова', 'Барбер · 4 года опыта', 'https://images.unsplash.com/photo-1544725176-7c40e5a71c5e?auto=format&fit=crop&w=900&q=85']], prices: ['3 800 ₽', '5 900 ₽', '3 300 ₽', '2 700 ₽'] }
  };
